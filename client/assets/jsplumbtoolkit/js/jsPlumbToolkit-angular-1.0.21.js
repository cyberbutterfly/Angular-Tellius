...
(function () {
    ...
    var _link = function (fn) {
        return function (scope, element, attrs, controller) {
            ...
            var _resync = function () {
                ...
                scope.$emit("refresh", scope.node);
            };
            scope.$watch(null, _resync);  // for the first paint
            scope.$watchCollection("node", _resync);  // for subsequent data changes. 
        };
    };
    ...
    angular.module('$jsPlumb', [])
                    ...
                    return {
                        ...
                        link: function (scope, element, attrs, controller) {
                            ...
                            jsPlumb.extend(p, {
                                ...
                                templateRenderer: function (directiveId, data, renderMode) {
                                    var newScope = scope.$new();
                                    newScope.node = data;
                                    newScope.toolkit = scope.toolkit;
                                    newScope.surface = scope.surface;
                                    var newNode = angular.element('<' + directiveId + ' node="node" toolkit="toolkit" surface="surface"></' + directiveId + '>');
        ...
        .service("jsPlumbService", [ '$templateCache', '$timeout', function ($templateCache, $timeout) {
             ...
             * @param {Function} Function to call when the event fires. The function is passed (toolkit, toolkitId, eventId) as args.
             */
             ...
             * @params {Object} params Constructor parameters for the component.
             * @params {String} type Type of component to add.
             */
             ...
             * @params {Object} params Constructor parameters for the Palette.
             */
             ...
             * @params {Object} params Constructor parameters for the Miniview.
             */
